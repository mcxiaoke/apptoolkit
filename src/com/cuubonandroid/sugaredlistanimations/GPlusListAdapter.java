 ...
 */
public abstract class GPlusListAdapter<T> extends GenericArrayAdapter<T> {

    protected GPlusListAdapter(Context context, SpeedScrollListener scrollListener, List<T> items) {
